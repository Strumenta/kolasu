...
open class ParseTreeToASTTransformer(
     ...
     */
    fun <P : ParserRuleContext> registerNodeTransformerUnwrappingChild(kclass: KClass<P>): NodeTransformer<P, INode> =
     ...
     */
    inline fun <reified P : ParserRuleContext> registerNodeFactoryUnwrappingChild(): NodeTransformer<P, INode> =
