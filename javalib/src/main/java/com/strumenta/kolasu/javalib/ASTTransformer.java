...
public class ASTTransformer extends com.strumenta.kolasu.transformation.ASTTransformer {
    ...
    protected <S, T extends BaseASTNode> NodeFactory<S, T> registerNodeFactory(Class<S> source, Function2<S, ? super com.strumenta.kolasu.transformation.ASTTransformer, T> function) {
