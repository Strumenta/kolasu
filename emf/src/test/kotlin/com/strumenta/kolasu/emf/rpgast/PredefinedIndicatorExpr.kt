...
// *IN01..*IN99
data class PredefinedIndicatorExpr(val index: Int, val specifiedPosition: Position? = null) :
...
// *IN
data class PredefinedGlobalIndicatorExpr(val specifiedPosition: Position? = null) :
    AssignableExpression(specifiedPosition) {
