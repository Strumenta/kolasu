...
//                        ref.setType(toLWClassifier(lionwebLanguage, it.type))
...
//                        cont.setType(toLWClassifier(lionwebLanguage, it.type))
...
fun ConceptLike.kClass() = Class.forName(this.name).kotlin
