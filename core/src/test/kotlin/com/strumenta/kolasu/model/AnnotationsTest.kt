...
class AnnotationsTest {
    ...
    fun singleAnnotation() {
        ...
        assertEquals(listOf(ann1), a.annotationsByType())
        assertEquals(listOf(), b.annotationsByType())
        ...
        assertEquals(listOf(), a.annotationsByType())
        ...
        assertEquals(listOf(ann3), a.annotationsByType())
        assertEquals(listOf(), b.annotationsByType())
    ...
    fun multipleAnnotation() {
        ...
        assertEquals(true, ann3.attached)
        assertEquals(a, ann3.annotatedNode)
        assertEquals(listOf(ann2, ann3), a.annotationsByType())
        assertEquals(listOf(), b.annotationsByType())
