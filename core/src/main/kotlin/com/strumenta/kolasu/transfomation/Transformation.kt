...
class NodeFactory<S>(
    ...
    fun withChild(sourceProperty: KProperty1<S, *>, property: KMutableProperty1<*, *>, type: KClass<*>? = null): NodeFactory<S> =
        withChild(
    ...
    fun <T : Any> withChild(path: String, property: KMutableProperty1<T, *>, scopedToType: KClass<T>? = null): NodeFactory<S> =
        withChild(getter(path), (property as KMutableProperty1<Any, Any?>)::set, property.name, scopedToType)

    fun <T : Any> withChild(
        get: (S) -> Any?, property: KMutableProperty1<in T, *>, scopedToType: KClass<T>? = null
...
data class ChildNodeFactory<S>(
    val name: String, val get: (S) -> Any?, val setter: (Any, Any?) -> Unit) {
            ...
            node::class.processProperties { pd ->
                ...
                if(childNodeFactory != null) {
                    ...
                    if(targetProp is KMutableProperty1 && mapped != null) {
                        ...
                        childNodeFactory = ChildNodeFactory(childKey,
