...
interface NodeIdProvider {
    ...
    ): String = idUsingCoordinates(kNode, overriddenCoordinates ?: calculatedCoordinates(kNode))

    private fun calculatedCoordinates(kNode: KNode): Coordinates =
