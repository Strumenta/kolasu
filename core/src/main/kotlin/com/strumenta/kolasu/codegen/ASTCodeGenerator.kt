...
abstract class ASTCodeGenerator<R : ASTNode> {
    ...
    protected inline fun <reified N1 : ASTNode> recordPrinter(crossinline generation: PrinterOutput.(ast: N1) -> Unit) {
        nodePrinters[N1::class] = NodePrinter { output: PrinterOutput, ast: ASTNode ->
