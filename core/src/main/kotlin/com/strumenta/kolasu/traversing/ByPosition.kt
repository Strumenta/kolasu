 ...
 */
@JvmOverloads
fun ASTNode.findByPosition(position: Position, selfContained: Boolean = false): ASTNode? {
 ...
 */
@JvmOverloads
fun ASTNode.searchByPosition(position: Position, selfContained: Boolean = false): Sequence<ASTNode> {
