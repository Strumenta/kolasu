 ...
 */
@JvmOverloads
fun ASTNode.findByRange(range: Range, selfContained: Boolean = false): ASTNode? {
 ...
 */
@JvmOverloads
fun ASTNode.searchByRange(range: Range, selfContained: Boolean = false): Sequence<ASTNode> {
 ...
 */
fun ASTNode.walkWithin(range: Range): Sequence<ASTNode> {
 ...
 */
fun List<ASTNode>.walkWithin(range: Range): Sequence<ASTNode> {
    return this
